            ...
            <div class="panel panel-info">
                <div class="panel-heading clearfix">
                    <div class="panel-title pull-left">
                        {{ trans_choice('keywords.categories', $categories->total()) }} : {{ $categories->total() }}
                    </div>
                    <div class="pull-right">
                        <a class="btn btn-primary"
                            href="{{ action('Admin\CategoryController@create') }}">{{ trans('keywords.add') }}</a>
                    </div>
                </div>
                ...
                @else
                    {{ trans('keywords.empty', ['item' => trans_choice('keywords.categories', 1)]) }}
                @endif
                </div>
